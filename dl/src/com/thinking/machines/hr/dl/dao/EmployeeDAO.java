...
if(gender==' ')    throw new DAOException("Gender mot set to MALE/FEMALE");
...
if(employeeId.length()==0)    throw new DAOException("Invalid Employee Id : "+employeeId+" Employee Id is of zero length");
try
{
File file=new File(FILE_NAME);
if(file.exists()==false)    throw new DAOException("Invalid Employee Id : "+employeeId);
...
panNumber=panNumber.trim();
if(panNumber.length()==0)    throw new DAOException("Invalid PAN Number : "+panNumber+" PAN Number is of zero length");
try
{
File file=new File(FILE_NAME);
...
aadharCardNumber=aadharCardNumber.trim();
if(aadharCardNumber.length()==0)    throw new DAOException("Invalid Aadhar Card Number : "+aadharCardNumber+" Aadhar Card Number is of zero length");
try
{
File file=new File(FILE_NAME);
